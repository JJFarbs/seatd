...
export const initialVenues = () => [
  { id: 'v1', name: 'Cobalt Room', area: 'Sandton', lat: -26.1070, lng: 28.0578, dist: 0.8, genre: 'Amapiano / House', when: 'Tonight 22:00', minFrom: 1500, tagline: 'Rooftop sessions, deep house till late.', g: ['#2BD4FF', '#7A4DFF'], status: 'live', img: '1566737236500-c8ac43014a67',
  ...
  { id: 'v2', name: 'Velvet & Vine', area: 'Rosebank', lat: -26.1445, lng: 28.0420, dist: 3.4, genre: 'R&B / Hip-Hop', when: 'Fri 23:00', minFrom: 2000, tagline: 'Low light, good people, better bottles.', g: ['#FF3DAE', '#7A4DFF'], status: 'live', img: '1514525253161-7a46d19cd819',
  ...
  { id: 'v3', name: 'The Loft 88', area: 'Braamfontein', lat: -26.1926, lng: 28.0341, dist: 6.1, genre: 'Afro-Tech', when: 'Sat 22:30', minFrom: 1000, tagline: 'Underground room, no phones on the floor.', g: ['#FFC24B', '#FF3DAE'], status: 'live', img: '1493225457124-a3eb161ffa5f',
  ...
  { id: 'v4', name: 'Mzansi Skybar', area: 'Maboneng', lat: -26.2049, lng: 28.0591, dist: 7.8, genre: 'Deep House', when: 'Tonight 21:00', minFrom: 1200, tagline: 'Skyline views, sunset to sunrise.', g: ['#3FE0C0', '#2BD4FF'], status: 'live', img: '1533174072545-7a4b6ad7a6c3',
  ...
  { id: 'v5', name: 'Ember', area: 'Soweto', lat: -26.2389, lng: 27.8899, dist: 18.5, genre: 'Gqom / Amapiano', when: 'Sat 22:00', minFrom: 800, tagline: 'Where the night actually starts.', g: ['#FF8A3D', '#FF3DAE'], status: 'live', img: '1516450360452-9312f5e86fc7',
