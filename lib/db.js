...
// Client that acts AS the logged-in user (forwards their token so row-level
// security rules apply to them). Falls back to the anonymous client.
export function dbFor(authHeader) {
